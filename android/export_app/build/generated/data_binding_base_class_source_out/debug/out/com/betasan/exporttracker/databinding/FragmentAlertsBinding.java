...
public final class FragmentAlertsBinding implements ViewBinding {
  ...
  private FragmentAlertsBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView rvAlerts) {
  ...
  public static FragmentAlertsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAlertsBinding((LinearLayout) rootView, rvAlerts);
    }
